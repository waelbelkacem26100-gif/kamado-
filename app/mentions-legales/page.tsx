    ...
    <main className="min-h-screen pt-32 pb-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <Section title="3. Propriété intellectuelle">
          <p>
            L&apos;ensemble du contenu du site kamaagency.com — incluant, de façon non limitative, les textes,
            graphismes, images, photographies, vidéos, icônes, sons, logiciels et toute autre information —
            est protégé par le droit d&apos;auteur et appartient à Kama Agency ou à ses partenaires.
          </p>
          <p>
            ...
            l&apos;autorisation écrite préalable de Kama Agency.
          </p>
          <p>
            Les marques et logos présents sur le site sont des marques déposées par Kama Agency ou par ses
            partenaires. Toute reproduction non autorisée de ces marques constitue une contrefaçon susceptible
        ...
        <Section title="4. Protection des données personnelles (RGPD)">
          <p>
            ...
            vous disposez de droits relatifs à vos données personnelles.
          </p>
          <p>
            <strong className="text-[var(--fg)]">Responsable du traitement :</strong> Kama Agency, Bendou Wael
            &amp; Salhi Idriss, 2 rue Étienne Dolet, 26100 Romans-sur-Isère.
          </p>
          <p>
            <strong className="text-[var(--fg)]">Données collectées :</strong> Lors de l&apos;utilisation du
            formulaire de contact, nous collectons les informations suivantes : nom, prénom, adresse email,
            numéro de téléphone (optionnel), société (optionnel), type de projet et message. Ces données sont
            nécessaires au traitement de votre demande.
          </p>
          <p>
            <strong className="text-[var(--fg)]">Finalité du traitement :</strong> Répondre à vos demandes de
            contact et de devis, établir des propositions commerciales, et assurer le suivi de la relation
            client.
          </p>
          <p>
            <strong className="text-[var(--fg)]">Durée de conservation :</strong> Vos données sont conservées
            pendant une durée maximale de 3 ans à compter de notre dernier échange.
          </p>
          <p>
            <strong className="text-[var(--fg)]">Vos droits :</strong> Vous disposez d&apos;un droit
          ...
          <p>
            ...
            <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-[var(--accent)] hover:underline">
              www.cnil.fr
            </a>.
          </p>
          <p>
            <strong className="text-[var(--fg)]">Partage des données :</strong> Vos données personnelles ne
            sont jamais vendues ni partagées à des tiers à des fins commerciales. Elles peuvent être transmises
            à nos sous-traitants techniques (hébergeur Vercel, service d&apos;envoi d&apos;emails Web3Forms)
            dans le cadre strict de l&apos;exécution du traitement.
          </p>
        </Section>

        <Section title="5. Politique relative aux cookies">
          <p>
            Un cookie est un fichier texte susceptible d&apos;être déposé dans un terminal lors de la
        ...
        <Section title="6. Limitation de responsabilité">
          <p>
            Kama Agency met tout en oeuvre pour offrir aux utilisateurs des informations et des outils
            disponibles et vérifiés, mais ne saurait être tenue pour responsable des erreurs,
          ...
          <p>
            ...
            contractuelle. Malgré des mises à jour régulières, la responsabilité du site ne peut être engagée
            en cas de modification des dispositions administratives et juridiques apparaissant après la
            publication.
          </p>
          <p>
        ...
        <Section title="7. Loi applicable et juridiction compétente">
          ...
          <p>
            Tout litige en relation avec l&apos;utilisation du site kamaagency.com est soumis au droit
            français. Il est fait attribution exclusive de juridiction aux tribunaux compétents de
        ...
        <Section title="8. Liens hypertextes">
          <p>
            ...
            Ces sites ne sont pas sous le contrôle de Kama Agency, qui ne peut être tenu responsable de leur
            contenu. L&apos;insertion de liens vers ces sites ne constitue pas une approbation de ces sites.
          </p>
        </Section>
